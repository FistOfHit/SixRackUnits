...
Announced just weeks after the 102.4T Tomahawk 6, the [new Tomahawk Ultra ASIC](https://investors.broadcom.com/news-releases/news-release-details/broadcom-ships-tomahawk-ultra-reimagining-ethernet-switch-hpc) is symbolic of Broadcom's scale-up Ethernet (SUE) overtaking UALink as the scale-up technology most capable of challenging Nvidia's NVLink. This new 51.2T (512 x 100G) switch expands the performance and capability boundaries of Broadcom's existing datacentre switch lineup, with its focus on lower latencies and higher packet processing rates as well as supporting SUE's requirements such as link-layer retry and credit-based flow control.
...
The more surprising improvement (and probably more impactful too) though is their packet processing rate. Claiming to process [77 Billion packets per second (pps)](https://www.naddod.com/blog/broadcom-tomahawk-ultra-new-chip-for-scale-up-ethernet) for packets as small as large as 64B, Broadcom are targeting traditional HPC infrastructures too despite the majority of their marketing centering on AI. Applications such as finite difference/element models, linear solvers, or even distributed financial/trading programs are all far more sensitive to latency than AI workloads are. Packet sizes in networking for AI workloads are usually far larger, over a thousand bytes sometimes. This has been the case for AI training for a while now, and recently has become the norm for AI inferencing too. This all means that AI workload networking latency is usually very high anyway, with the focus being on overall throughput instead of packet rates. As a result, HPC clusters using dense and complex topologies running non-AI workloads will benefit much more from the high pps provided by the Tomahawk Ultra.
...
This timely ramp up comes as news to some because back in Q2 it was reported that [shipments would be delayed](https://www.linkedin.com/posts/aletheiacapital_bestglobaltechhardwareteam-nvidia-gb300-activity-7320755976528097281-8LUX/) and analysts were speculating on how this would impact sales of Nvidia's next generation VR200 "Vera Rubin" servers. The issue causing the delays has since been mitigated rather than being truly resolved - parts were replaced rather than undergoing an immediate and effective design change. The "Cordelia" baseboard that Nvidia planned to introduce for the GB300's denser and higher-performance design was struggling to pass validation and reports from April suggested that [signal loss](https://x.com/Jukanlosreve/status/1914617184971526144) stemming from the doubling in bandwidth across the the NVLink traces was severe enough to cost Nvidia two quarters of delay.

Ultimately, it was decided that [reverting to the old baseboard design](https://x.com/Jukanlosreve/status/1946073863693169003) for the GB200s (Bianca) was the best option to meet deadlines. This meant that Nvidia would provide the B300 GPUs in a SXM "puck" modular form factor, and soldered Grace CPUs and LPDDR5X memory to the server manufacturers. The knock on effects mean that the proposed SOCAMM memory module design used to make the memory easily replaceable for repair, [now must be introduced later with Vera CPUs](https://www.tomshardware.com/pc-components/gpus/nvidia-postpones-socamm-technology-originally-planned-for-blackwell-ultra-gb300-now-scheduled-for-rubin-rubin-ultra). The upside to all of this was letting the supply chain can breathe for once, [using existing parts and experience](https://www.tweaktown.com/news/106480/nvidias-next-gen-gb300-ai-servers-now-in-production-will-begin-shipping-september/index.html) from the GB200 manufacturing process rather than rapidly adopting the latest specifications from Nvidia in a bid to hit the September shipping deadlines.

![](https://raw.githubusercontent.com/FistOfHit/SixRackUnits/refs/heads/main/newsletters/2025/july/images/gb300_socamm.jpg)

*Source: SixRackUnits - Above: Bianca board with LPDDR5X memory soldered to the board next to the Grace CPU. Below: The proposed design for the Cordelia board using quick replaceable SOCAMM modules in the same location.*

There hasn't been any update on what, if anything, Nvidia and their supply chain have done to address the liquid cooling issues that have been [rumoured in the GB200s](https://mp.weixin.qq.com/s?chksm=fbc55528ccb2dc3e97dbf3ac94f65e3f0065a467d80a2bb8dc0fa3128f0d2f3207b8d5326653&exptype=unsubscribed_card_recommend_article_u2i_mainprocess_coarse_sort_tlfeeds&ranksessionid=1752912746_1&mid=2247486037&sn=c25851920d412e008b1ed65d22e9c3ff&idx=1&__biz=MzU1NjUwMTUyMg%3D%3D&scene=169&subscene=200&sessionid=1752912745&flutter_pos=13&clicktime=1752912771&enterid=1752912771&finder_biz_enter_id=5&jumppath=20020_1752912748097%2CWebViewStubProxyUI_1752912749788%2C20020_1752912749904%2C50094_1752912758176&jumppathdepth=4&ascene=56&fasttmpl_type=0&fasttmpl_fullversion=7825680-en_US-zip&session_us=gh_6c32bda7f91f) in deployment currently. It seems that the quick connect fittings used to speed up the deployment and maintenance of the servers have been the primary cause of leaks but no noticeable changes have been made to address this yet. Though compared to the previous generation of HGX/DGX servers which were pushing the limits of what air cooling could handle, the current and future liquid-cooled versions will still be more reliable and performant, for many reasons that we will discuss in later posts.

![](https://raw.githubusercontent.com/FistOfHit/SixRackUnits/refs/heads/main/newsletters/2025/july/images/gb300_tray.jpg)
